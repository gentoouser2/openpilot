...
C3X Lite (no cabin camera): `installer.comma.ai/gentoouser2/main`. Read [C3X_LITE.md](C3X_LITE.md).
...
- **Driver monitoring** — Stock openpilot driver monitoring camera on comma 3X; C3X Lite uses FrogPilot-style passive steering/accelerator attention fallback (no cabin camera)
