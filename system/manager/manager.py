...
# C3X Lite has no cabin/driver camera. Set before any child processes spawn.
os.environ["C3X_LITE"] = "1"
...
def manager_init() -> None:
  ...
  if os.getenv("C3X_LITE") is not None:
    params.put_bool("RecordFront", False)
    params.put_bool("AlwaysOnDM", False)
  elif params.get_bool("RecordFrontLock"):
