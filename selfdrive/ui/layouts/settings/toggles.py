...
class TogglesLayout(Widget):
  def __init__(self):
    ...
    hide_on_lite = {"RecordFront", "AlwaysOnDM"} if os.getenv("C3X_LITE") is not None else set()
    self._scroller = Scroller([t for p, t in self._toggles.items() if p not in hide_on_lite],
